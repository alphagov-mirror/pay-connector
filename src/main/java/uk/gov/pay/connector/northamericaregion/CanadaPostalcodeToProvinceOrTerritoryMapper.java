...
public class CanadaPostalcodeToProvinceOrTerritoryMapper {
    ...
    private final static Pattern WELL_FORMED_POSTAL_CODE = Pattern.compile("([A-Z])[0-9][A-Z][0-9][A-Z][0-9]");
    private final static Pattern WELL_FORMED_X_POSTAL_CODE = Pattern.compile("(X[0-9][A-Z])[0-9][A-Z][0-9]");
    private final static String SANTA_CLAUS_POSTAL_CODE = "H0H0H0";
