...
public class RefundExpungeServiceTest {
    ...
    private int defaultMinimumAgeForHistoricRefundExceptions = 10;
    ...
    public void setUp() {
        ...
        when(mockExpungeConfig.getMinimumAgeForHistoricRefundExceptions()).thenReturn(defaultMinimumAgeForHistoricRefundExceptions);
