...
public class TestTemplateResourceLoader {
    ...
    public static final String WORLDPAY_VALID_AUTHORISE_WORLDPAY_REQUEST_INCLUDING_3DS_NO_SHOPPER_IP_ADDRESS = WORLDPAY_BASE_NAME + "/valid-authorise-worldpay-request-including-3ds-no-shopper-ip-address.xml";
